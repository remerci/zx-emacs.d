...
;; Emacs版本: 24.4.1, http://www.cnblogs.com/aqing1987/p/4187101.html, add by zx
...
(setq org-publish-project-alist
      '(
        ("notes"
         :base-directory "/windata/notes/org/"
         :base-extension "org"
         :publishing-directory "/windata/notes/org/html/"
         :recursive t
        ...
        ("org-note" :components ("notes" "note-static"))
        ("slide"
         :base-directory "/windata/notes/org/"
         :base-extension "org"
         :publishing-directory "/windata/notes/org/slides/"
...
'((sequence "TODO(t)" "DOING(i!)" "HANGUP(h@/!)" "|" "DONE(d!)" "CANCLE(c@/!)" )
(sequence "REPORT" "BUG" "KNOWNCAUSE" "|" "FIXED")
(sequence "|" "CANCELED")
;(type "赵鑫(x)" "张召光(g)" "邹富春(f)" "付浩洁等(s)" "|" "DONE(d)" "CANCLE(c)" )
))
